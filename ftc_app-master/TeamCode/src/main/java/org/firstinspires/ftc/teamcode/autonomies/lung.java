...
@Autonomous
public class lung extends LinearOpMode
{
    private static final String paths[] =new String[3];
    private static final double desiredHeading = -1f;
    ...
    void latching()
    {
        ...
        rob.arm_left.setTargetPosition(3100);
        rob.arm_right.setTargetPosition(3100);
    ...
    void lower_arm()
    {
        ...
        rob.arm_right.setPower(0.5f);
        rob.arm_left.setPower(0.5f);
        rob.arm_right.setTargetPosition(-200);
        rob.arm_left.setTargetPosition(-200);
